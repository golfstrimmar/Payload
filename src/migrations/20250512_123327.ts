...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "events_media_urls" (
  ...
  DO $$ BEGIN
   ALTER TABLE "events_media_urls" ADD CONSTRAINT "events_media_urls_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
  ...
  DO $$ BEGIN
   ALTER TABLE "locations" ADD CONSTRAINT "locations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "events_media_urls_order_idx" ON "events_media_urls" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "events_media_urls_parent_id_idx" ON "events_media_urls" USING btree ("_parent_id");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "locations_name_idx" ON "locations" USING btree ("name");
  CREATE INDEX IF NOT EXISTS "locations_user_idx" ON "locations" USING btree ("user_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "events_media_urls" CASCADE;
